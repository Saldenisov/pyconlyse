...
namespace DS_LaserPointing_Wrapper
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.Title = "DS_LaserPointing - Tango Device Server";
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine("Usage: DS_LaserPointing.exe [instance_name]");
                    Console.WriteLine("Example: DS_LaserPointing.exe 1_LaserPoint_V0");
                    return 1;
                }
                ...
                Console.WriteLine("=====================================================");
                Console.WriteLine("DS_LaserPointing - Tango Device Server Wrapper");
                Console.WriteLine("=====================================================");
...
psi.Arguments = "/k \"title DS_LaserPointing [" + instanceName + "] && " +
                              "cd /d \"" + pyconlyse + "\\DeviceServers\\control\\laser_pointing\" && " +
                              ...
                              "echo Starting DS_LaserPointing device server... && " +
                              "python DS_LaserPointing.py " + instanceName + "\\"";
                ...
                if (process != null)
                {
                    ...
                    Console.WriteLine("Terminal window title: DS_LaserPointing [" + instanceName + "]");
                    Console.WriteLine("");
