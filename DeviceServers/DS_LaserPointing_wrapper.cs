...
string deviceDir = Path.Combine(pyconlyse, @"DeviceServers\control\laser_pointing");
string title = "DS_LaserPointing [" + instanceName + "]";
...
string innerCmd = "cmd /k \"call \"" + activatePath + "\" " + pyconlyseEnv +
                  ...
                  " && echo Starting DS_LaserPointing device server... && python DS_LaserPointing.py " + instanceName + "\"";
