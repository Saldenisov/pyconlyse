...
call "%PYCONLYSE%\DeviceServers\launch_device_server.cmd" "DS_ANDOR_CCD [%INSTANCE_NAME%]" "DS_ANDOR_CCD" "%INSTANCE_NAME%" "%PYCONLYSE%\DeviceServers\cameras\andor" "DS_ANDOR_CCD.py" "DISABLE_ARCHIVE=1"
