...
namespace DS_DAQmx_ZMQ_Wrapper
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.Title = "DS_DAQmx_ZMQ - Tango Device Server";
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine("Usage: DS_DAQmx_ZMQ.exe [instance_name]");
                    Console.WriteLine("Example: DS_DAQmx_ZMQ.exe 1_DAQMX_ZMQ_1");
                    return 1;
                }
                ...
                Console.WriteLine("=====================================================");
                Console.WriteLine("DS_DAQmx_ZMQ - Tango Device Server Wrapper");
                Console.WriteLine("=====================================================");
                ...
                string title = "DS_DAQmx_ZMQ [" + instanceName + "]";
                ...
                string innerCmd = "cmd /k \"call \"" + activatePath + "\" " + pyconlyseEnv +
                                  ...
                                  " && echo Starting DS_DAQmx_ZMQ device server... && python DS_DAQmx_zmq.py " + instanceName + "\"";
