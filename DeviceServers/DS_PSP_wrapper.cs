...
namespace DS_PSP_Wrapper
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.Title = "DS_PSP - Tango Device Server";
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine("Usage: DS_PSP.exe [instance_name]");
                    Console.WriteLine("Example: DS_PSP.exe 1");
                    return 1;
                }
                ...
                Console.WriteLine("=====================================================");
                Console.WriteLine("DS_PSP - Tango Device Server Wrapper");
                Console.WriteLine("=====================================================");
                ...
                string deviceDir = Path.Combine(pyconlyse, @"DeviceServers\control\psp");
                string title = "DS_PSP [" + instanceName + "]";
