...
call "%PYCONLYSE%\DeviceServers\launch_device_server.cmd" "DS_Standa_Motor [%INSTANCE_NAME%]" "DS_Standa_Motor" "%INSTANCE_NAME%" "%PYCONLYSE%\DeviceServers\motion\standa" "DS_Standa_Motor.py" "DISABLE_ARCHIVE=1"
