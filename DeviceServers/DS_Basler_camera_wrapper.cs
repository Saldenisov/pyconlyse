...
namespace DS_Basler_camera_Wrapper
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.Title = "DS_Basler_camera - Tango Device Server";
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine("Usage: DS_Basler_camera.exe [instance_name]");
                    Console.WriteLine("Example: DS_Basler_camera.exe 1_Cam1_V0");
                    return 1;
                }
                ...
                Console.WriteLine("=====================================================");
                Console.WriteLine("DS_Basler_camera - Tango Device Server Wrapper");
                Console.WriteLine("=====================================================");
                ...
                psi.Arguments = "/k \"title DS_Basler_camera [" + instanceName + "] && " +
                              "cd /d \"" + pyconlyse + "\\DeviceServers\\cameras\\basler\" && " +
                              "\"" + anaconda + "\\Scripts\\activate.bat\" " + pyconlyseEnv + " && " +
                              "echo Starting DS_Basler_camera device server... && " +
                              "python DS_Basler_camera.py " + instanceName + "\"";
                psi.UseShellExecute = true;
                psi.CreateNoWindow = false;
                psi.WindowStyle = ProcessWindowStyle.Normal;

                // Astor starts devices sequentially, so no startup delays needed
                ...
                if (process != null)
                {
                    ...
                    Console.WriteLine("Terminal window title: DS_Basler_camera [" + instanceName + "]");
                    Console.WriteLine("");
