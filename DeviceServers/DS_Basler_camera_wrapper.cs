...
string deviceDir = Path.Combine(pyconlyse, @"DeviceServers\cameras\basler");
string title = "DS_Basler_camera [" + instanceName + "]";
...
string innerCmd = "cmd /k \"call \"" + activatePath + "\" " + pyconlyseEnv +
                  ...
                  " && echo Starting DS_Basler_camera device server... && python DS_Basler_camera.py " + instanceName + "\"";
