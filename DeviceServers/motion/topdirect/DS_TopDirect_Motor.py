...
class DS_TopDirect_Motor(DS_MOTORIZED_MONO_AXIS):
    RULES = {
        "set_state_arduino": [DevState.ON, DevState.INIT],
        **DS_MOTORIZED_MONO_AXIS.RULES,
    }
    """"
    ...
    def read_position_local(self) -> Union[int, str]:
        ...
        if reply:
            ...
            data = self.form_archive_data(self._position, "position", dt="float16")
