...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Register a dedicated OWIS PS90 Tango device for IP-connected controller."
    )
    parser.add_argument("--device-name", default="manip/general/DS_OWIS_PS90_WIZZ")
    parser.add_argument("--instance", default="2_WIZZ")
    parser.add_argument("--server-id", default="2")
    parser.add_argument("--device-id", default="2")
    parser.add_argument("--friendly-name", default="DS_OWIS_PS90_WIZZ")
    ...
    print(f"Controller endpoint: {args.controller_ip}:{args.controller_port}")
