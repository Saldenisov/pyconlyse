...
call "%PYCONLYSE%\DeviceServers\launch_device_server.cmd" "DS_DAQmx [%INSTANCE_NAME%]" "DS_DAQmx" "%INSTANCE_NAME%" "%PYCONLYSE%\DeviceServers\control\daqmx" "DS_DAQmx.py" "DISABLE_ARCHIVE=1"
