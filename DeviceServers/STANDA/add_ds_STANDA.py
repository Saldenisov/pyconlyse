...
names = {'00003D73': ['ELYSE/motorized_devices', 'StandaI_X', 'MM1_X', [-10, 0, 10], [-300, 300], 15731,
         ...
         '00003D8F': ['manip/V0', 'StandaIII_Y', 'MM3_Y', [-10, 0, 10], [-300, 300], 15759,
                      ['', 1]],
         '000043F3': ['manip/V0', 'IrisExp_1', 'DV01', [0, 10, 20, 50, 80, 100], [0, 100], 17395,
                      ['%', 20.61]],
         '000043D9': ['manip/V0', 'IrisExp_2', 'DV02', [0, 10, 15, 25, 40, 80, 100], [0, 100], 17369,
                      ['%', 21.85]],
         '00004A38': ['manip/V0', 'IrisExp_3', 'DV03', [0, 10, 15, 25, 40, 80, 100], [0, 100], 19000,
                      ['%', 22.46]],
         '00004A3E': ['manip/V0', 'IrisExp_4', 'DV04', [0, 10, 15, 25, 40, 80, 100], [0, 100], 19006,
                      ['%', 22.38]],
         ...
         '00004A10': ['manip/V0', 'Flipper_1', 'F1', [-1, 1], [-1.1, 1.1], 18960,
                      ['', 1250]],
         '00004399': ['manip/V0', 'Lambda_2_Exp', 'L-2_1', [-100, -50, -10, 0, 10, 50, 100], [0, 100], 17305,
                      ['%', 37.00]],
         ...
         '000043DE': ['manip/V0', 'translation_stage_OPA_m', 'TS_OPA_m', [-10, 0, 10], [-100, 100], 2,
                      ['mm', 833.3333]],
         '000043F5': ['ELYSE/motorized_devices', 'IrisElyse_1', 'DE1', [0, 9.2, 15, 25, 40, 80, 100], [0, 100], 17397,
                      ['%', 21.59]],
         '000043FC': ['ELYSE/motorized_devices', 'IrisElyse_2', 'DE2', [0, 9.2, 15, 25, 40, 80, 100], [0, 100], 17404,
                      ['%', 22.32]],
