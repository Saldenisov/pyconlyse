...
namespace DS_ANDOR_SPECTROGRAPH_Wrapper
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.Title = "DS_ANDOR_SPECTROGRAPH - Tango Device Server";
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine("Usage: DS_ANDOR_SPECTROGRAPH.exe [instance_name]");
                    Console.WriteLine("Example: DS_ANDOR_SPECTROGRAPH.exe 1_ANDOR_SHAMROCK1");
                    return 1;
                }
                ...
                Console.WriteLine("=====================================================");
                Console.WriteLine("DS_ANDOR_SPECTROGRAPH - Tango Device Server Wrapper");
                Console.WriteLine("=====================================================");
                ...
                string deviceDir = Path.Combine(pyconlyse, @"DeviceServers\spectrographs\andor");
                string title = "DS_ANDOR_SPECTROGRAPH [" + instanceName + "]";
                string activatePath = Path.Combine(anaconda, @"Scripts\activate.bat");
                string innerCmd = "cmd /k \"call \"" + activatePath + "\" " + pyconlyseEnv +
                                  " && set DISABLE_ARCHIVE=1 && set PYTHONPATH=" + pyconlyse +
                                  " && echo Starting DS_ANDOR_SPECTROGRAPH device server... && python DS_ANDOR_SPECTROGRAPH.py " + instanceName + "\"";
