...
namespace DS_KEYSIGHT_33509B_Wrapper
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.Title = "DS_KEYSIGHT_33509B - Tango Device Server";
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine("Usage: DS_KEYSIGHT_33509B.exe [instance_name]");
                    Console.WriteLine("Example: DS_KEYSIGHT_33509B.exe MAIN");
                    return 1;
                }
                ...
                Console.WriteLine("=====================================================");
                Console.WriteLine("DS_KEYSIGHT_33509B - Tango Device Server Wrapper");
                Console.WriteLine("=====================================================");
                ...
                string deviceDir = Path.Combine(pyconlyse, @"DeviceServers\instruments\keysight");
                string title = "DS_KEYSIGHT_33509B [" + instanceName + "]";
...
string innerCmd = "cmd /k \"call \"" + activatePath + "\" " + pyconlyseEnv +
                                  ...
                                  " && echo Starting DS_KEYSIGHT_33509B device server... && python DS_KEYSIGHT_33509B.py " + instanceName + "\"";
