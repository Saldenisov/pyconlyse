...
namespace DS_ANDOR_CCD_Wrapper
{
    class Program
    {
        static int Main(string[] args)
        {
            Console.Title = "DS_ANDOR_CCD - Tango Device Server";
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine("Usage: DS_ANDOR_CCD.exe [instance_name]");
                    Console.WriteLine("Example: DS_ANDOR_CCD.exe 1_ANDOR_CCD1");
                    return 1;
                }
                ...
                Console.WriteLine("=====================================================");
                Console.WriteLine("DS_ANDOR_CCD - Tango Device Server Wrapper");
                Console.WriteLine("=====================================================");
                ...
                string deviceDir = Path.Combine(pyconlyse, @"DeviceServers\cameras\andor");
                string title = "DS_ANDOR_CCD [" + instanceName + "]";
                ...
                string innerCmd = "cmd /k \"call \"" + activatePath + "\" " + pyconlyseEnv +
                                  ...
                                  " && echo Starting DS_ANDOR_CCD device server... && python DS_ANDOR_CCD.py " + instanceName + "\"";
