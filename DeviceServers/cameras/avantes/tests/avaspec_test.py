...
from msl.equipment.resources.avantes.avaspec import *
...
print(
    "  m_Detector.m_DefectivePixels: %r"
    % [val for val in params.m_Detector.m_DefectivePixels]
)
...
print(
    "  m_Irradiance.m_IntensityCalib.m_Smoothing.m_SmoothPix: %d"
    % params.m_Irradiance.m_IntensityCalib.m_Smoothing.m_SmoothPix
)
print(
    "  m_Irradiance.m_IntensityCalib.m_Smoothing.m_SmoothModel: %d"
    % params.m_Irradiance.m_IntensityCalib.m_Smoothing.m_SmoothModel
)
print(
    "  m_Irradiance.m_IntensityCalib.m_CalInttime: %d"
    % params.m_Irradiance.m_IntensityCalib.m_CalInttime
)
...
m_Trigger.m_Mode = 2
m_Trigger.m_Source = 0
m_Trigger.m_SourceType = 0
