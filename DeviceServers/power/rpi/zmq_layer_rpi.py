...
def main(ip_adress: int):
    ...
    def generate_TTL(
        ...
        if number_ttl >= 1 and delay > 0 and width > 0:
            ...
            delay = delay / 10**6
            print(
                f"Start to generate TTL pulses {number_ttl} with width {width} and dt {delay}."
            )
            print("[", end="")
            i = 1
            while mypin.active and mypin.ttl_done < number_ttl:
                ...
                if mypin.ttl_done / number_ttl > i * 0.1:
                    i += 1
                    print("#", end="")
    ...
    while True:
        ...
        if msg != -1:
            ...
            if cmd == "TTL":
                ...
                get_ttl_accomplished(
                    pin_number=msg["pin_number"], id=id, order_id=msg["order_id"]
                )
            elif cmd == "TOGGLE":
