...
class MajorDomoBroker:
    ...
    # We'd normally pull these from config datastructures
        ...
        while True:
            ...
            if items:
                ...
                if MDP.C_CLIENT == header:
                    self.process_client_message(sender, msg)
                elif MDP.W_WORKER == header:
                    self.process_worker_message(sender, msg)
                else:
    ...
    def delete_worker(self, worker, disconnect):
        """Deletes worker from all datastructures structures, and deletes worker."""
