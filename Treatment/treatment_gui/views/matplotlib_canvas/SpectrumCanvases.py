...
from treatment_gui.views.matplotlib_canvas.KineticsCanvases import KineticsCanvas
...
class SpectrumCanvas(KineticsCanvas):
    ...
    def draw_cursors(self, draw=True, cursors=None):
        if cursors:
            ...
            self.axis.axvline(x=cursors.x1[1], color='r', linewidth=2)
            self.axis.axvline(x=cursors.x2[1], color='r', linewidth=2)
