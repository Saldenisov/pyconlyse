'''
Base canvas classes with improved styling for Treatment GUI.
...
class MyMplCanvas(FigureCanvas):
    ...
    def __init__(self, width: int, height: int, dpi: int, canvas_parent, measurement: Measurement=None):
        ...
        # Increase font sizes
        self.axis.tick_params(labelsize=14)
        self.axis.xaxis.label.set_fontsize(16)
        self.axis.yaxis.label.set_fontsize(16)
        self.axis.title.set_fontsize(18)
