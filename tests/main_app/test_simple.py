...
class TestTangoInfrastructureManager(unittest.TestCase):
    ...
    @patch("main_app.managers.infrastructure_manager.subprocess.Popen")
...
class TestDeviceServerManager(unittest.TestCase):
    ...
    @patch("main_app.managers.device_manager.Path.exists", return_value=False)
    ...
    @patch("main_app.managers.device_manager.Path.exists", return_value=True)
    @patch("main_app.managers.device_manager.subprocess.Popen")
    ...
    def test_bulk_operations(self):
        ...
        with patch("main_app.managers.device_manager.Path.exists", return_value=False):
