...
class Ui_ProjectManager(object):
    def setupUi(self, ProjectManager):
        ...
        self.horizontalLayout_3.addWidget(self.groupBox_files)
        self.groupBox_description = QtWidgets.QGroupBox(self.centralwidget)
        ...
        self.horizontalLayout_3.addWidget(self.groupBox_description)
