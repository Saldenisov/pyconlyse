...
timeout 10
REM start cmd /c %PYCONLYSE%\bin\start_all_NETIO.cmd
start cmd /c %PYCONLYSE%\bin\start_all_OWIS.cmd
start cmd /c %PYCONLYSE%\bin\start_all_BASLER.cmd
REM start cmd /c %PYCONLYSE%\bin\start_all_STANDA.cmd
REM start cmd /c %PYCONLYSE%\bin\start_all_TOPDIRECT.cmd
timeout 7
