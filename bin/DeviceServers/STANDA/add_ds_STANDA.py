...
names = {'00003D73': ['ELYSE/motorized_devices', 'StandaI_X', 'MM1_X', [-10, 0, 10], [-300, 300]],
         ...
         '000043F3': ['manip/V0', 'IrisExp_1', 'DV01', [0, 100, 350, 650, 850], [0, 850]],
         '000043D9': ['manip/V0', 'IrisExp_2', 'DV02', [0, 100, 350, 650, 850], [0, 850]],
         '00004A38': ['manip/V0', 'IrisExp_3', 'DV03', [0, 100, 350, 650, 850], [0, 850]],
         '00004A3E': ['manip/V0', 'IrisExp_4', 'DV04', [0, 100, 350, 650, 850], [0, 850]],
         '000043FE': ['manip/V0', 'ShutterExp_1', 'S1', [-1250, 1250], [-1350, 1350]],
         '000043CA': ['manip/V0', 'ShutterExp_2', 'S2', [-1250, 1250], [-1350, 1350]],
         ...
         '000043F5': ['ELYSE/motorized_devices', 'IrisElyse_1', 'DE1', [0, 100, 350, 650, 850], [0, 850]],
         '000043FC': ['ELYSE/motorized_devices', 'IrisElyse_2', 'DE2', [0, 100, 350, 650, 850], [0, 850]],
...
for dev_id, val in names.items():
    ...
    dev_info.server = f'DS_Standa_Motor/{i}'
